...
privateLandImage <- rast("mapLayers/images/privateLand.tif")
privateLandImage <- RGB(privateLandImage, type = "RGB")
...
palGreen <- colorNumeric(
  palette = brewer.pal(n = 10, name = "YlGn"),
...
# Enviroment
  ...
  addLegend("bottomleft", col = c(palGreen, "orange"), label = c("Canopy Cover", "Moose Wintering Area"), title = "Enviroment") %>%
  addLayersControl(
    overlayGroups = c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Survey Area", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Enviroment: Canopy Cover","Enviroment: Moose wintering area"),
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup(c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Enviroment: Canopy Cover","Enviroment: Moose wintering area"))
```

## Private land map
<iframe src="https://www.lioapplications.lrc.gov.on.ca/CLUPA/index.html?viewer=CLUPA.CLUPA&locale=en-CA">
